...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "SasCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SasCoin features */
        {"sascoin", "masternode", &masternode, true, true, false},
        {"sascoin", "listmasternodes", &listmasternodes, true, true, false},
        {"sascoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sascoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sascoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sascoin", "masternodedebug", &masternodedebug, true, true, false},
        {"sascoin", "startmasternode", &startmasternode, true, true, false},
        {"sascoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sascoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sascoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sascoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sascoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sascoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sascoin", "mnbudget", &mnbudget, true, true, false},
        {"sascoin", "preparebudget", &preparebudget, true, true, false},
        {"sascoin", "submitbudget", &submitbudget, true, true, false},
        {"sascoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sascoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sascoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sascoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sascoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sascoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sascoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sascoin", "checkbudgets", &checkbudgets, true, true, false},
        {"sascoin", "mnsync", &mnsync, true, true, false},
        {"sascoin", "spork", &spork, true, true, false},
        {"sascoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"sascoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use sascoind, or the -server option to sascoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> sascoin-cli " + methodname + " " + args + "\n";
}
