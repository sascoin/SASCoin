...
/** 
    ...
    ****Note - for SasCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of sascoin coming in to a transaction
