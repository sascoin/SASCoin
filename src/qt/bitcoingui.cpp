                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SasCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SasCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sascoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSAS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SasCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about SasCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SasCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SasCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SasCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a SasCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SasCoin Core help message to get a list with possible SasCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SasCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SasCoin network", "", count));
}
...
{
    QString strTitle = tr("SasCoin Core"); // default title
