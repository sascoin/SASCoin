...
/** Utility functions used by the SasCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render SasCoin addresses in monospace font
...
// Parse "sascoin:" URI into recipient object, return true on successful parsing
