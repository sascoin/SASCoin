                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received SAS from zSAS"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zSAS"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zSAS));
