...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SasCoin Core sascoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sascoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sascoin transaction") + "\n" +
                               "  sascoin-tx [options] -create [commands]   " + _("Create hex-encoded sascoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sascoin transaction
