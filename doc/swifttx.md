...
This mechanism has been integrated into Bitcore-Node-SasCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SasCoin-Project/insight-api-sascoin#web-socket-api](https://github.com/SasCoin-Project/insight-api-sascoin#web-socket-api) 
* API: [https://github.com/SasCoin-Project/insight-api-sascoin#swifttx-transactions](https://github.com/SasCoin-Project/insight-api-sascoin#swifttx-transactions) 
...
By default, the SasCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SasCoin Core daemon:
