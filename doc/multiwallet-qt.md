...
In order to support loading of multiple wallets in sascoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sascoin.cpp.
...
Changes to sascoin.cpp
----------------------
sascoin.cpp is the entry point into sascoin-qt, and as such, will require some minor modifications to provide hooks for
