Contributing to SasCoin Core
============================

The SasCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SasCoin Core project, and is not to be
confused with overall SasCoin Network Protocol consensus changes.

Whether a pull request is merged into SasCoin Core rests with the project merge
...
Patches that change SasCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the SasCoin consensus, it must have been
...
The project leader is the release manager for each SasCoin Core release.
