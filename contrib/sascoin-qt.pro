...
RESOURCES += src/qt/sascoin.qrc src/qt/sascoin_locale.qrc

TRANSLATIONS += src/qt/locale/sascoin_bg.ts \
                src/qt/locale/sascoin_de.ts \
                src/qt/locale/sascoin_en.ts \
                src/qt/locale/sascoin_es.ts \
                src/qt/locale/sascoin_fi.ts \
                src/qt/locale/sascoin_fr.ts \
                src/qt/locale/sascoin_it.ts \
                src/qt/locale/sascoin_ja.ts \
                src/qt/locale/sascoin_pl.ts \
                src/qt/locale/sascoin_pt.ts \
                src/qt/locale/sascoin_ru.ts \
                src/qt/locale/sascoin_sk.ts \
                src/qt/locale/sascoin_sv.ts \
                src/qt/locale/sascoin_vi.ts \
                src/qt/locale/sascoin_zh_CN.ts \
                src/qt/locale/sascoin_zh_TW.ts
